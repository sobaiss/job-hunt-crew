...
SYSTEM_PROMPT = (
    ...
    "Keep the letter concise — up to about 2000 characters — written in "
    "flowing prose paragraphs; do not use bullet-point lists in the letter "
    "body. Refer to prior roles by title and accomplishment rather than "
    "naming former employers. Write with correct grammar and spelling. "
    "If the letter's language is French, follow the classic candidate "
    "cover-letter convention: open with a dated header line, then an "
    "'Objet : Candidature au poste de ...' line naming the role from the job "
    "offer below, then structure the body around the 'Vous / Moi / Nous' "
    "logic — the company's needs first, then your fit, then what you bring "
    "and a call for an interview — as ordinary paragraphs. Do NOT print "
    "'Vous', 'Moi', or 'Nous' themselves as section headings or labels "
    "anywhere in the letter; the three-part logic should be invisible "
    "structure, not visible headers. This header and structure convention "
    "applies only in French; skip it for any other language. "
